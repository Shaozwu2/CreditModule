...
@ApiModel(value = "CreateTnCToPriceBook", description = "Create TnC resource representation")
@XmlAccessorType(XmlAccessType.FIELD)
public class CreateTnCToPriceBookDto {
	...
	public void validateCreateTnCToPriceBook() {
